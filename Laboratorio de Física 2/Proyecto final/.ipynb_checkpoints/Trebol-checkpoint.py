...
Calidad = 500
x = np.linspace(-0.07, 0.06, Calidad)
...
for contour in contours:
    for i in range(len(contour) - 1):
        ...
        wire = [(contour[i][0][0] * scale_factor - 0.0585 , contour[i][0][1] * scale_factor - 0.045 ),
                (contour[i+1][0][0] * scale_factor - 0.0585 , contour[i+1][0][1] * scale_factor - 0.045 )]
